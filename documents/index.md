...
- [NF-8](requirements.md#48-nf-8-project-scoped-codex-support-important) — Codex Support (repo-scoped `.codex/config.toml` + `.agents/skills` wrappers verified; marketplace install path empirically broken at codex v0.128.0) — `[~]` (marketplace pending)
