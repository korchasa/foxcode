...
- [NF-8](requirements.md#48-nf-8-project-scoped-codex-support-important) — Project-Scoped Codex Support (repo `.codex/config.toml` + `.agents/skills` wrappers; plugin packaging deferred) — `[~]` (plugin distribution pending)
