...
export const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description: [
      ...
      'DOM helpers accept CSS selectors only. Playwright-style selectors such as `text=...` and `:has-text(...)` are invalid.',
      'For text matching, use api.eval(...) or api.snapshot() instead of selector strings.',
      '',
      'API Reference:',
      ...
      '  const button = [...document.querySelectorAll("button")].find((el) => (el.textContent || "").includes("Continue"));',
      ...
      '  if (snapshot.includes("Welcome")) break;',
